...
const Cart = () => {
    ...
    const totalAmt = (Number(amtWithOutTax) + Number(taxAmt)).toFixed(2);
  return (
    <>
      <section className="py-5 sm:py-7 bg-blue-100">
        <div className="container max-w-screen-xl mx-auto px-4">
          <h2 className="text-1xl font-semibold mb-1">{ cart?.cartItems?.length || 0} Item(s) in Cart</h2>
        </div>
      </section>
                      ...
                      <div className="w-full lg:w-2/5 xl:w-2/4">
                        <figure className="flex leading-5">
                          ...
                          <figcaption className="ml-3">
                            ...
                            <p className="mt-1 text-gray-400">{cartItem.seller}</p>
                          </figcaption>
                        </figure>
                    </div>
                      <div className="w-24">
